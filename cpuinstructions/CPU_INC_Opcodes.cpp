...
template int CPU::op_INC_n<&CPU::C, false>();
template int CPU::op_INC_n<&CPU::D, false>();
template int CPU::op_INC_n<&CPU::E, false>();
template int CPU::op_INC_n<&CPU::H, false>();
template int CPU::op_INC_n<&CPU::L, false>();
template int CPU::op_INC_n<&CPU::A, false>();
template int CPU::op_INC_n<nullptr, true>();
// ========================= Instruccion INC nn ===============================
